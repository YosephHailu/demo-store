      ...
      <div class="col-lg-10 col-xl-8">
        <div class="card" style="border-radius: 10px;">
          <div class="card-header px-4 py-5">
            <h5 class="text-muted mb-0">Thanks for your Order, <span style="color: #a8729a;">{{ $order->store->name }}</span>!</h5>
          </div>
          <div class="card-body p-4">
            ...
            <div class="card shadow-0 border mb-4">
              <div class="card-body">
                <div class="row">
                  <div class="col-md-2">
                    <img src="{{ $item->product->first_photo_url }}"
            ...
            <div class="d-flex justify-content-between pt-2">
              ...
              <p class="text-muted mb-0"><span class="fw-bold me-4">Total</span> ${{ number_format($order->orderItems->sum('price'), 2) }} </p>
            </div>
            ...
            <div class="d-flex justify-content-between">
              <p class="text-muted mb-0">Invoice Date : {{ \Carbon\Carbon::parse($order->created_at)->format('d M Y') }}</p>
