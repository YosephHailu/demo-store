<div class="d-flex flex-column flex-shrink-0 p-3 bg-light shadow-lg" style="width: 280px; min-height: 100vh">
  ...
  <ul class="nav nav-pills flex-column mb-auto">
    ...
    <li>
      <a href="{{ route('product.index') }}" class="nav-link link-dark {{ (request()->is('product*')) ? 'active' : '' }}">
    ...
    <li>
      <a href="{{ route('product_category.index') }}" class="nav-link link-dark {{ (request()->is('product_categories*')) ? 'active' : '' }}">
